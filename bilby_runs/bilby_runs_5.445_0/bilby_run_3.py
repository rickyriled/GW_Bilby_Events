...
prior_dictionary = dict(
    ...
    dec=bilby.core.prior.DeltaFunction(peak=0.1),
    ra=bilby.core.prior.DeltaFunction(peak=5.2),
...
result = bilby.run_sampler(
    ...
    walks=100, check_point_delta_t=15000, npool=50, outdir=outdir, label=label,
